...
const Header = ({ show, showMenu }) => {
  ...
  const sideMenu = {
    ...
    icon: {
      backgroundColor:
        displayMenu && 'rgba(76, 126, 75, 0.63140, 233, 139, 0.63)',
    ...
    userIcon: {
      backgroundColor:
        displayUserMenu && 'rgba(76, 126, 75, 0.63140, 233, 139, 0.63)',
  ...
  return (
    <header>
      ...
      <nav>
        ...
        <NavLink to={'/troquez'} activeclassname="active">
          Troquez !
        </NavLink>
        {user && (
      ...
      {displayMenu && (
        <div className="alt-menu" style={sideMenu.button}>
          ...
          <NavLink to="/commentcamarche">Comment ça marche ?</NavLink>
          <NavLink to={user ? '/troquez' : '/login'}>Troquez !</NavLink>
          {user && <NavLink to="/stock">Mon stock</NavLink>}
        ...
        <div className="alt-user-menu" style={sideMenu.user}>
          {user ? (
            <div className="side-user-menu">
              <div className="side-menu-info-user"></div>
